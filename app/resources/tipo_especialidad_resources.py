...
def crear_tipo_especialidad():
    ...
    nuevo_tipo_especialidad = TipoEspecialidadService.crear_tipo_especialidad(data)
...
def actualizar_tipo_especialidad(id):
    ...
    tipo_especialidad_actualizado = TipoEspecialidadService.actualizar_tipo_especialidad(datos_actualizados)
