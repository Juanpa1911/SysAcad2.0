def registrar_blueprints(app):
    from app.resources import home_bp, universidad_bp, area_bp, cargo_bp, alumno_bp, tipo_dedicacion_bp, departamento_bp, especialidad_bp, autoridad_bp, facultad_bp  # ,  certificado_bp
