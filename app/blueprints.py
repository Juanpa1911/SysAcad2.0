def registrar_blueprints(app):
    from app.resources import home_bp, universidad_bp, area_bp, cargo_bp, alumno_bp, tipo_dedicacion_bp, departamento_bp, especialidad_bp, autoridad_bp, facultad_bp, tipo_doc_bp, grupo_bp  # ,  certificado_bp
    ...
    app.register_blueprint(tipo_doc_bp, url_prefix='/api/v1')
