...
class EspecialidadTestCase (BaseTestCase):
    ...
    def test_crear_especialidad(self):
        ...
        self._assert_especialidad(especialidad, "Ingeniería en Sistemas", "Especialidad de Ingeniería en Sistemas", "IS")
        
    def test_buscar_por_id(self):
        especialidad = nuevaEspecialidad()
        EspecialidadService.crear_especialidad(especialidad)
        encontrada = EspecialidadService.buscar_por_id(especialidad.id)
        self._assert_especialidad(encontrada, "Ingeniería en Sistemas", "Especialidad de Ingeniería en Sistemas", "IS")
